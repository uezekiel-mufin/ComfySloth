...
const Newsletter = () => {
  return (
    <div className='pt-20 pb-20 px-8 md:px-20 md:py-60 mx-4 flex flex-col gap-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
        ...
        <form
          ...
          action='https://formspree.io/f/mvoyonrw'
          method='POST'
        >
          <input
            name='email'
            ...
            type='text'
            className='border-2 border-solid border-[#222] h-11 border-r-0 w-full p-4'
          />
